// 独立的菜谱内容源；仅用于本轮交互预览，不读取或写入家庭/订单数据。
...
export const recipes = [
  {
    id: 'tomato-eggs', name: '番茄炒蛋', subtitle: '酸酸甜甜，是家的味道', category: 'home', art: 0,
    minutes: 12, difficulty: '新手友好', servings: 2, unit: '人份', label: '下饭担当', complete: true,
    flavors: ['不辣', '微辣', '中辣'], defaultFlavor: '不辣',
  ...
  {
    id: 'potato-chicken', name: '土豆焖鸡', subtitle: '软糯土豆，承包一碗饭', category: 'home', art: 1,
    minutes: 35, difficulty: '小试身手', servings: 2, unit: '人份', label: '家的拿手菜', complete: true,
    flavors: ['不辣', '微辣', '中辣'], defaultFlavor: '微辣', note: '收汁时留一点汤汁，土豆拌饭真的很香。',
  ...
  {
    id: 'garlic-greens', name: '蒜蓉小青菜', subtitle: '给餐桌加一点绿意', category: 'vegetable', art: 2,
    minutes: 8, difficulty: '新手友好', servings: 2, unit: '人份', label: '轻盈一餐', complete: true,
    flavors: ['清淡', '蒜香'], defaultFlavor: '蒜香', note: '青菜沥干再下锅，大火快炒，颜色更好看。',
  ...
  {
    id: 'corn-soup', name: '玉米排骨汤', subtitle: '咕嘟咕嘟，暖到心里', category: 'soup', art: 3,
    minutes: 60, difficulty: '慢慢来就好', servings: 2, unit: '人份', label: '暖胃小幸福', complete: true,
    flavors: ['原味'], defaultFlavor: '原味', note: '盐在最后放，让玉米的清甜先慢慢煮进汤里。',
    ingredients: [ingredient('rib', '排骨', 300, 'g'), ingredient('corn', '玉米', 1, '根'), ingredient('carrot', '胡萝卜', 1, '根'), ingredient('ginger', '生姜', 10, 'g'), ingredient('water', '清水', 1000, 'ml'), ingredient('salt', '盐', 3, 'g')],
  ...
  {
    id: 'latte', name: '暖暖拿铁', subtitle: '把日子泡得香香的', category: 'coffee', art: 4,
    minutes: 5, difficulty: '新手友好', servings: 1, unit: '杯', label: '咖啡时间', complete: true,
    flavors: ['无糖', '微甜'], defaultFlavor: '无糖', note: '没有奶泡机，也可以用温牛奶直接兑浓缩。',
  ...
  {
    id: 'french-toast', name: '草莓法式吐司', subtitle: '把早晨过成小小节日', category: 'breakfast', art: 5,
    minutes: 15, difficulty: '新手友好', servings: 1, unit: '人份', label: '待补充步骤', complete: false,
    flavors: ['原味'], defaultFlavor: '原味', note: '这份菜谱还在记录中，完整做法补好后就可以跟着做啦。',
    ingredients: [ingredient('bread', '厚吐司', 2, '片'), ingredient('egg', '鸡蛋', 1, '个'), ingredient('milk', '牛奶', 60, 'ml'), ingredient('butter', '黄油', 10, 'g'), ingredient('strawberry', '草莓', 4, '颗')], steps: []
  }
]

export function resolveIngredients(recipe, flavor, servings) {
  return recipe.ingredients.map(item => {
    const base = item.flavorAmounts?.[flavor] ?? item.amount
