...
function initRuntimeSocketService() {
  const hosts = "192.168.1.3,127.0.0.1,172.19.128.1,172.25.192.1";
  const port = "8090";
  const id = "mp-weixin_ZP_ttM";
