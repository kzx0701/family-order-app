...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.0.226,10.10.20.5";
  const port = "8090";
  const id = "mp-weixin_lbDd0o";
...
const pages = [
  ...
  {
    path: "pages/order-success/order-success",
    style: {
      navigationStyle: "custom",
...
const globalStyle = {
  ...
  backgroundColorTop: "#FFFBF5",
  backgroundColorBottom: "#FFFBF5"
};
const tabBar = {
  custom: true,
  color: "#78716C",
...
const easycom = {
  autoscan: true,
  custom: {
    "^fo-(.*)": "@/components/fo-$1/fo-$1.vue",
    "^Icon$": "@/components/icons/Icon.vue",
    "^CustomTabbar$": "@/components/custom-tabbar/custom-tabbar.vue"
  }
};
const condition = {
  current: 0,
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), T = b, C = I('{"address":["127.0.0.1","192.168.0.226","10.10.20.5"],"servePort":7001,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"]}'), P = I('[{"provider":"aliyun","spaceName":"my-family","spaceId":"mp-da7724ea-3e73-4aec-af28-d255a2a4f62e","clientSecret":"eDqzGLPlr5+jFbHQlIcMVA==","endpoint":"https://api.next.bspapp.com","failoverEndpoint":""}]') || [];
let E = "";
try {
  E = "__UNI__FAMILY_ORDER";
} catch (e2) {
}
let L = {};
function R(e2, t2 = {}) {
